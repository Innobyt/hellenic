...
var billingmaintenance = require('./billingmaintenance.model');
...
exports.index = function(req, res){
    ...
    billingmaintenance.find(function(err, collection_billingmaintenance){
        ...
        res.json(collection_billingmaintenance);
    });
}
...
exports.show = function(req, res){
    ...
    billingmaintenance.findById(queryid, function(err, found){
		// a generic error message, given when an unexpected condition was enco
		// untered and no more specific message is suitable.
        if (err) return handleError(res, err);
...
exports.create = function(req, res){
	var save_billingmaintenance = new billingmaintenance(req.body);
	// save expense table entry in expense table collection
	save_billingmaintenance.save(function(err) {
...
exports.update = function(req, res){
	...
	billingmaintenance.findByIdAndUpdate(id, update, function(err, numberAffected, raw){
		// the request was well-formed but was unable to be followed due to sem
		// antic errors.
		if(err) return validationError(res, err);
...
exports.destroy = function(req, res){
	...
	billingmaintenance.findByIdAndRemove(id, function(err, found) {
		// a generic error message, given when an unexpected condition was enco
		// untered and no more specific message is suitable.
		if(err) return handleError(res, err);

...
var vesseltable = require('./vesseltable.model');
...
exports.index = function(req, res){
    ...
    vesseltable.find(function(err, collection_vesseltable){
        ...
        res.json(collection_vesseltable);
    });
}
...
exports.show = function(req, res){
    ...
    vesseltable.findById(queryid, function(err, found){
		// a generic error message, given when an unexpected condition was enco
		// untered and no more specific message is suitable.
        if (err) return handleError(res, err);
...
exports.create = function(req, res){
	var save_vesseltable = new vesseltable(req.body);
	// save vessel table entry in vessel table collection
	save_vesseltable.save(function(err) {
...
exports.update = function(req, res){
	...
	vesseltable.findByIdAndUpdate(id, update, function(err, numberAffected, raw){
		// the request was well-formed but was unable to be followed due to sem
		// antic errors.
		if(err) return validationError(res, err);
...
exports.destroy = function(req, res){
	...
	vesseltable.findByIdAndRemove(id, function(err, found) {
		// a generic error message, given when an unexpected condition was enco
		// untered and no more specific message is suitable.
		if(err) return handleError(res, err);
